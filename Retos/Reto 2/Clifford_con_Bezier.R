...
x4 <-c(0.43, 0.41 , 0.41 , 0.4)
y4 <- c(0.7, 0.65, 0.61 ,0.59)
grid.bezier(x4,y4,gp=gpar(lwd = 2, fill="black")) #Oreja Derecha
...
grid.bezier(x6,y6,gp=gpar(lwd = 2, fill="black")) #Parte superior Cuerpo

x7 <-c(0.73, 0.78 , 0.59 , 0.83)
y7 <-c(0.25, 0.3, 0.55,0.58)
grid.bezier(x7,y7,gp=gpar(lwd = 2, fill="black")) #Cola

x8 <-c(0.83, 0.69 , 0.87 , 0.735)
y8 <-c(0.58, 0.46, 0.32,0.205)
grid.bezier(x8,y8,gp=gpar(lwd = 2, fill="black")) #Cola
...
grid.bezier(x12,y12,gp=gpar(lwd = 2, fill="black")) #Patita

x13 <-c(0.4997, 0.4896 , 0.479 , 0.4911)
y13 <-c(0.0544, 0.0459, 0.0284,0.0014)
grid.bezier(x13,y13,gp=gpar(lwd = 2, fill="black")) #Patita
...
grid.bezier(x17,y17,gp=gpar(lwd = 2, fill="black")) #Patita 2

x18 <-c(0.3403, 0.3253 , 0.3207 , 0.3295)
y18 <-c(0.0546, 0.0485, 0.0172,0.0014)
grid.bezier(x18,y18,gp=gpar(lwd = 2, fill="black")) #Patita 2

x19 <-c(0.4293, 0.4544 , 0.4805 , 0.5072)
y19 <-c(0.1296, 0.107, 0.1032,0.0892)
grid.bezier(x179,y19,gp=gpar(lwd = 2, fill="black")) #Parte Inferior cuerpo

x20 <-c(0.3306, 0.2236 , 0.164 , 0.2436)
y20 <-c(0.1966, 0.275, 0.4314,0.554)
grid.bezier(x20,y20,gp=gpar(lwd = 2, fill="black")) #Parte Inferior cuerpo
...
grid.bezier(x24,y24,gp=gpar(lwd = 2, fill="black")) #Patita 3

x25 <-c(0.2213, 0.211 , 0.191 , 0.2202)
y25 <-c(0.0684, 0.06, 0.0334,0.0014)
grid.bezier(x25,y25,gp=gpar(lwd = 2, fill="black")) #Patita 3

x26 <-c(0.1573, 0.0674 , 0.0286 , 0.1278)
y26 <-c(0.7335, 0.71, 0.8203,0.8426)
grid.bezier(x26,y26,gp=gpar(lwd = 2, fill="black")) #Oreja Izquierda

x27 <-c(0.1278, 0.1614 , 0.191 , 0.2494)
y27 <-c(0.8426, 0.8456, 0.816,0.8454)
grid.bezier(x27,y27,gp=gpar(lwd = 2, fill="black")) #Oreja Izquierda

x28 <-c(0.25, 0.2418 , 0.2392 , 0.2196)
y28 <-c(0.83, 0.827, 0.788,0.7744)
grid.bezier(x28,y28,gp=gpar(lwd = 2, fill="black")) #Cara
...
grid.bezier(x38,y38,gp=gpar(lwd = 2, fill="black")) # Boca

x39 <-c(0.234, 0.269, 0.29, 0.2942)
y39 <-c(0.771, 0.7875, 0.7804, 0.8276)
grid.bezier(x39,y39,gp=gpar(lwd = 2, fill="black")) # Boca
